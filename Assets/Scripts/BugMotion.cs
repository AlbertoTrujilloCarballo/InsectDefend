...
public class BugMotion : MonoBehaviour
{
    ...
    [SerializeField] float damageValue = 2.5f; // Cantidad de daño que hace el enemigo
    ...
    private void Start()
    {
        ...
        StartCoroutine(TooFastTooFurios());
    }
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision != null)
        {
            ...
            if (collision.collider.CompareTag("Trap"))
            {
                ...
                GameObject.Find("GameManager").GetComponent<GameManager>().enemigos++;
    ...
    IEnumerator TooFastTooFurios()
    {
        while (true)
        {
            yield return new WaitForSeconds(0.25f);
            bugSpeed = Mathf.Clamp(bugSpeed + 0.25f, bugSpeed, 10);
        }
    }
